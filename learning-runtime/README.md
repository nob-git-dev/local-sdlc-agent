...
collection, completeness audit, redaction, and causal recovery-episode
construction. Knowledge mining and promotion are later slices and cannot bypass
...
Integration Gate A (`EL01`-`EL06`) passed on 2026-08-01 and Integration Gate
B (`EL07`) passed on 2026-08-02. Domain mapping, candidate mining,
cross-project validation, promotion, snapshots, and rollback remain planned
under `EL08`-`EL12` and are not presented as implemented features.
