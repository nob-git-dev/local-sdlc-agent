...
- 学習基盤は L01〜L04（EL01〜EL06）、Integration Gate A、P04/P05 の実 recovery capture、L05（EL07）/Gate B、L06（EL08）/Gate C、L07（EL09）/Gate D、L08（EL10）/Gate E、L09/Gate F、L10（EL11）/Gate G の順に完了した。次の学習 slice は L11 の運用・説明CLIとする。
